...
BuildRequires: %{?scl_prefix}rubygem(activejob)  = %{version}
BuildRequires: %{?scl_prefix}rubygem(mail) >= 2.5.4
BuildRequires: %{?scl_prefix}rubygem(mail) < 3
BuildRequires: %{?scl_prefix_ruby}rubygem(minitest) >= 5.1.0
